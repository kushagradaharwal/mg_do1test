...
/**
 * @category   Clarion
 * @package    Abandoned Carts
 * @created    18th Dec, 2014
 * @author     23th March, 2015
 * @purpose    Abandoned Carts collection
 */
class Clarion_AbandonedCarts_Model_Resource_Quote_Collection extends Mage_Sales_Model_Resource_Quote_Collection
{
     ...
     * @param string $filter
     * @return Clarion_AbandonedCarts_Model_Resource_Quote_Collection
     */
