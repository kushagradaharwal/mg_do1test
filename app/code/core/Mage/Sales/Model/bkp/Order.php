...
class Mage_Sales_Model_Order extends Mage_Sales_Model_Abstract
{
    ...
    public function sendNewOrderEmail()
    {
      ...
      /* Set all required params and send emails
		...
		$dir = Mage::getBaseDir();
        $file_name = $dir.DS.'var'.DS.'docs'.DS.'file.pdf'; //file path
...
//$media_file = str_replace('index.php/', '', $media_url); 
//echo '<pre>';print_r($collection->getData());die;
		...
		{  
			...
			$fileContents = file_get_contents($file_name);
			$filename = 'file.pdf';
			$mailer1->addAttachment($fileContents, $filename);
		...
		$fileatt = $file_name;// Path to the file (example)
